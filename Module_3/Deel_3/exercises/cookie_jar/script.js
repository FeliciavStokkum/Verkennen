...
function create_button(soortKnop){
    ...
    switch(soortKnop) {
        ...
        case 'take':
          ...
          knop.addEventListener('click', proccess_takecookie_click);
          break;
        default:
          // code block
          knop.textContent = 'Plaats de deksel'
      }
...
function proccess_takecookie_click(){
    ...
    //vul deze variable met het element cookie-jar
    // vul deze variablelen met het huidige aantal cookies in de jar 
